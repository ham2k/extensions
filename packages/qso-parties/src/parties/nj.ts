...
export const PARTY: QsoPartyParams = {
  ...
  legacyRefs: [{ type: "qp", prefix: "nj" }],
  state: "NJ",
  cabrilloName: "NJQP",
  url: "https://sites.google.com/view/k2td-bcrc/nj-qp/rules",
  status: "Dates and scoring verified for 2026 against the sponsor’s rules",
  lastUpdated: "2026-09-12 12:00Z",
  periods: [
  ...
  powerMultipliers: { QRP: 4, LOW: 2, HIGH: 1 },
  entryClasses: {
