...
//
// The event has no exchange of its own (§4.4: a signal report, "with or without
// the park identifier") and its logs name parks by POTA number (§8.4), so the
...
/// The listed Texas parks we are operating from. [operation] is the
