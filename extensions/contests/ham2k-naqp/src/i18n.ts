...
//
// User-visible strings for the NAQP extension, following CQ WW's pattern:
// per-locale flat key → string catalogs in i18n/<locale>.json, with hooks
// building a translator from `ctx.locale` via `tFor`. Location codes and
// operator names are exchange data, never translated.
