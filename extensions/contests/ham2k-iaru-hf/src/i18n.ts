...
//
// User-visible strings for the IARU HF extension, following CQ WW's pattern:
// per-locale flat key → string catalogs in i18n/<locale>.json, with hooks
// building a translator from `ctx.locale` via `tFor`. Society abbreviations and
// IARU office codes are exchange data, never translated.
