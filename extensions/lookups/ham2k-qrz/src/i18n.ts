...
//
// User-visible strings for the QRZ extension (the account dialog's
// credential-test feedback and the account definition's description/field
// labels). The per-locale catalogs live in i18n/<locale>.json (flat key →
// string maps, editable without touching code); hooks build a translator
